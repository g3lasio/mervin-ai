  ...
  return (
    <div className="min-h-screen py-20">
      <Helmet>
        ...
        <meta name="description" content="Choose the perfect plan for your construction business. Start Pay As You Go at $0.20/credit with 120 welcome credits — no monthly fee, no credit card required. Upgrade anytime." />
      </Helmet>
      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-4">
            Start <strong>Pay As You Go</strong> with <strong>120 welcome credits</strong> at <strong>$0.20/credit</strong> — no monthly fee, no credit card required. Upgrade to a subscription for automatic monthly credit refills and no watermarks.
          </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Every AI-powered action in Owl Fenc uses credits. All new accounts receive <strong>120 welcome credits</strong> to explore the full platform — credits cost <strong>$0.20 each</strong>, no monthly fee required.
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  creating AI-powered estimates, property verification, and more. All new accounts start with <strong>120 welcome credits</strong> (credits cost <strong>$0.20 each</strong>). 
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  ...
                  You get full access to every feature in Owl Fenc using credits at <strong>$0.20 per credit</strong>. Start with 120 welcome credits, 
